  ...
  return (
    ...
    <div className="relative overflow-hidden">
        ...
        {product?.featured && <Badge
            variant="accent"
            className="absolute top-3 left-3 bg-gradient-to-r from-accent to-yellow-500">Featured
                      </Badge>}
        {/* Wishlist button */}
        <button
        ...
        <div
            ...
            <Button
                ...
                <ApperIcon name="Plus" className="w-4 h-4 mr-2" />Quick Add
                          </Button>
        </div>
    </div>
    <div className="p-4 space-y-2">
        <h3
            className="font-medium text-primary group-hover:text-accent transition-colors duration-200 line-clamp-1">
            {product?.name}
        </h3>
        ...
        <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
                <span
                    className="font-display text-lg font-semibold bg-gradient-to-r from-accent to-yellow-600 bg-clip-text text-transparent">${product?.price?.toFixed(2)}${product.price}
                </span>
